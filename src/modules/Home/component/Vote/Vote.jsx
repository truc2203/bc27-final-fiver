        ...
        <div className="vote-sd">
          <Slider {...settings}>
                <div className="d-flex align-items-center voted">
                    ...
                    <div className="col-xl-7 col-12">
                        <div className="vote-ct">
                            <p className="vote-hd pt-2 pt-xl-0">Brighid Gannon (DNP, PMHNP-BC), Co-Founder | <img className="d-inline vote-i" src="https://fiverr-res.cloudinary.com/npm-assets/@fiverr/logged_out_homepage_perseus/apps/lavender-logo-x2.89c5e2e.png" alt="" /></p>
                            <p className="vote-quote py-3 py-xl-0">
                ...
                <div className="d-flex align-items-center voted">
                    ...
                    <div className="col-xl-7 col-12">
                        <div className="vote-ct">
                            <p className="vote-hd pt-2 pt-lg-0">Tim and Dan Joo, Co-Founders | <img className="d-inline vote-i" src="https://fiverr-res.cloudinary.com/npm-assets/@fiverr/logged_out_homepage_perseus/apps/haerfest-logo-x2.03fa5c5.png" alt="" /></p>
                            <p className="vote-quote py-3 py-lg-0">
                ...
                <div className="d-flex align-items-center voted">
                    ...
                    <div className="col-xl-7 col-12">
                        <div className="vote-ct">
                            <p className="vote-hd pt-2 pt-lg-0">Kay Kim, Co-Founder | <img className="d-inline vote-i" src="https://fiverr-res.cloudinary.com/npm-assets/@fiverr/logged_out_homepage_perseus/apps/rooted-logo-x2.321d79d.png" alt="" /></p>
                            <p className="vote-quote py-3 py-lg-0">
                ...
                <div className="d-flex align-items-center voted">
                    ...
                    <div className="col-xl-7 col-12">
                        <div className="vote-ct">
                            <p className="vote-hd pt-2 pt-lg-0">Caitlin Tormey, Chief Commercial Officer | <img className="d-inline vote-i" src="https://fiverr-res.cloudinary.com/npm-assets/@fiverr/logged_out_homepage_perseus/apps/naadam-logo-x2.0a3b198.png" alt="" /></p>
                            <p className="vote-quote py-3 py-lg-0">
