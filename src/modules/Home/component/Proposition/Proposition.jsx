        ...
        <div className='m-container my-xl-5 my-0'>
            <div className="d-flex align-items-center proposition">
                <div className="col-xl-6 col-12 proposition-right">
                    <p className='category-heading pb-4'>A whole world of freelance talent at your fingertips</p>
                ...
                <div className="col-xl-6 col-12">
                    <div className="modal-video">
                        <img className='proposition-img' src="https://fiverr-res.cloudinary.com/q_auto,f_auto,w_700,dpr_1.0/v1/attachments/generic_asset/asset/089e3bb9352f90802ad07ad9f6a4a450-1599517407052/selling-proposition-still-1400-x1.png" alt="" loading='auto' />
